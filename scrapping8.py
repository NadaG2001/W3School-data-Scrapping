...
# Send a GET request to the SASS tutorials page
...
with open("w3schools_sass_tutorials.csv", "w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerow(["Title", "Link"])
    for tutorial in tutorials:
        title = tutorial.text.strip()
        link = "https://www.w3schools.com/sass/" + tutorial["href"]
        writer.writerow([title, link])
